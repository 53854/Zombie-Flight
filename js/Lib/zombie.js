...
function zombieConfig(amount, spawnPositionX, spawnPositionY, spawnOffset){
    ...
    for (var i = 0; i < amount; i++){
        ...
        var bal = new balloon(game, 0, 0 - zombie.height, "balloon", true);
        zombie.addChild(bal);
...
class zobbie extends Phaser.Sprite{
    ...
    constructor(game, x, y, spawntime) {
        ...
        this.animations.add('left', [3, 4], 10, false);
        this.animations.add('right', [6, 7], 10, false);

        this.animations.add('flyUp', [0, 5], 10, false);
        this.animations.add('flyLeft', [1, 2], 10, false);
        this.animations.add('flyRight', [8, 8], 10, false);
    ...
    update(){
        ...
        game.physics.arcade.collide(this, [collisionLayer, zombies]);
        game.physics.arcade.collide(this.children, [collisionLayer, zombies]);
    ...
    /* Redudency will be resolved next patch */
    ...
    zombieBlowNewBalloon(){
        game.time.events.add(game.time.now + 10000, function(){
            var newBal = new balloon(game, 0, 0 - this.height, "balloon", true);
